    ...
    <div v-if="shopInfo" class="goods">
               ...
               <ul>
                   <li v-for="(item,index) in recommend.items" :key="index">
                       ...
                       <div class="recommend-food">
                           <p class="recommend-food-name">{{recommend.name}}</p>
       ...
       <div class="menuview">
           ...
           <div class="menu-wrapper" ref="menuScroll">
               <ul>
                   <li :class="{'current':currentIndex === index}" v-for="(item,index) in shopInfo.menu" :key="index" @click="selectMenu(index)">
